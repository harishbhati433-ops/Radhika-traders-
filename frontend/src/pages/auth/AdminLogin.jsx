  ...
  return (
    <AuthShell title="Admin Access" subtitle="Restricted — Radhika Traders control panel">
      <form onSubmit={submit} className="space-y-4">
        ...
        <div><Label>Password</Label><Input data-testid="admin-password" type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="mt-1.5" /></div>
