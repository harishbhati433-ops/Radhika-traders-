...
- Dynamic everywhere: Footer, Contact page, WhatsAppFloat, MaintenancePage, AuthShell help box (login/signup), customer sidebar SupportBox, ShareKit/ReferEarnCard/CampaignDetail WhatsApp messages, WelcomeLetter, emails (_wrap/_signature), poster (share_kit), deactivated-account message, owner_email added to withdrawal alert recipients.
